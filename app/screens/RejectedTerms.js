      ...
      <SimpleScreen headline="Vamos sentir sua falta :)">
        <View style={{paddingHorizontal: 20, marginBottom: 20}}>
          <Sentence style={{marginBottom: 20}}>
            Escreva para <Text onPress={onContact} style={{fontFamily: 'OpenSans-Bold'}}>temacucar@gmail.com</Text> caso queira compartilhar o motivo de ter recusado os termos. Vai ser um prazer falar com você!
          </Sentence>
          <Sentence>
